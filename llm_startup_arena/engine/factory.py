...
EXTERNAL_CANDIDATES = (
    ...
    ("daniel-brooks", "Daniel Brooks", EmployeeRole.SALES, EmployeePersonality.COMPETITIVE, 70, 7_000),
    ("elena-ionescu", "Elena Ionescu", EmployeeRole.OPERATIONS, EmployeePersonality.RELIABLE, 66, 6_000),
)
